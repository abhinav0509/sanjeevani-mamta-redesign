				...
				<?php if(!empty($result)){?>
					 <div class="about-countinner">
						...
						<div class="row" style="margin-left:-8px;margin-right:-8px;padding:8px">
							<h4 style="text-decoration:underline;"><?php echo $row['designation'];?> <span style="float:right;font-weight:100;font-size:12px;">Posting Date : <?php echo $row['posted_date'];?></span></h4>
							<p>Closing Date : <?php echo $row['closing_date'];?></p>
						...
						<?php if($cnt==0){?>
							<div class="panel panel-default">
                                ...
                                <div id="<?php echo $row['id'];?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="border:1px solid #f5f5f5;padding-left:15px;padding-top:10px;background:#F9F9F9">
                                    <p>Closing Date : <?php echo strip_tags($row['closing_date'],"<p>");?></p>
									<p>Qualification : <?php echo strip_tags($row['qualification'],"<p>");?></p>
...
<!-- SLIDER END -->
<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Welcome/career">

	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<h2 class="sec_Hd">MISSION &amp VISION </h2>
					<div class="about-countinner md-services">
				<?php if(!empty($result)){?>
					 <!--<div class="about-countinner">
						<h2 class="sec_Hd">ABOUT US</h2>
						<?php foreach($result as $row){?>
						<h4>♦ <?php echo $row['title'];?></h4>
						<?php if($row['image']!=""){?>
						<img class="img-responsive singlebanner" src="<?php echo base_url();?>data/uploads/aboutus/<?php echo $row['image'];?>" style="width:100%;height:300px;">
						<?php } ?>
						...
						<?php if($cnt==0){?>
							<div class="panel panel-default">
                                ...
                                <div id="<?php echo $row['id'];?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="border:1px solid #f5f5f5;padding:15px;background:#F9F9F9">
                                    <?php echo strip_tags($row['pdesc'],"<p>");?>
                                </div>
                            </div>
                        <?php } else {?>
							<div class="panel panel-default">
                                <div class="panel-heading" role="tab" id="headingOne">
                                    <h4 class="panel-title">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $row['id'];?>" aria-expanded="false" aria-controls="collapseOne">
                                           <?php echo $row['title'];?>
                                            <span class="fa fa-plus close-icon floatright"></span>
                                            <span class="fa fa-minus open-icon floatright"></span>
                                        </a>
                                    </h4>
                                </div>
                                <div id="<?php echo $row['id'];?>" class="panel-collapse collapse " role="tabpanel" aria-labelledby="headingOne" style="border:1px solid #f5f5f5;padding:15px;background:#F9F9F9">
                                    <?php echo strip_tags($row['pdesc'],"<p>");?>
                                </div>
                            </div>
						<?php } $cnt++; }?>   					 

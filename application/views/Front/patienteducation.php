        ...
        <section class="about_area section-padding" style="padding-top:16px;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="about_cont medd" style="text-align:center;">
						<?php if(!empty($result)){?>
							 <div class="about-countinner md-services">
								<h2 class="sec_Hd"> PATIENT EDUCATION</h2>
								<?php foreach($result as $row){?>
								<img src="<?php echo base_url();?>front/img/ptedu.jpg" class="img-responsive">

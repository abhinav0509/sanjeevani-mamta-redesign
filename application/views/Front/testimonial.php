                    ...
                    <div class="col-md-9">
						...
						<?php if($result!=""){?>
							 <div class="about-countinner md-services">
								<h2 class="sec_Hd"> TESTIMONIAL</h2>
								<?php foreach($result as $row){?>
								<div class="row">
									<div class="col-sm-3">
									<?php if($row['image']!=""){?>
										<img src="<?php echo base_url();?>data/uploads/testimonial/<?php echo $row['image'];?>" class="img-responsive" style="width:139px;height:130px;">
									<?php } else {?>
										<img src="<?php echo base_url();?>front/img/13.jpg" class="img-responsive" style="width:139px;height:130px;">
									<?php }?>
									</div>
									<div class="col-sm-9">
										<h5><em>To : <?php echo $row['dr_id'];?></em></h5>
										<p>

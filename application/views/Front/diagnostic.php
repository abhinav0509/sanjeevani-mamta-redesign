				 ...
				 <div class="sided" style="padding: 10px;margin-bottom:5px;">
					...
					<div class="categories area_content">
						...
						<?php foreach($dept as $fac){?>
							<li><a href="<?php echo base_url();?>index.php/Welcome/diagnostics/<?php echo $fac['id'];?>"> <?php echo $fac['name'];?></a></li>
						<?php } ?>
						</ul>
					</div>
				 </div>		
			...
			<div class="col-md-9">
				...
				<?php if(!empty($result)){?>
					 ...
					 <?php foreach($result as $row){?>
						...
						<img src="<?php echo base_url();?>data/uploads/diagnostics/<?php echo $img[$i];?>" class="img-responsive" style="height:250px;">
						</div>
						<?php } } else {?>
						<img src="<?php echo base_url();?>data/uploads/diagnostics/<?php echo $row['image'];?>" class="img-responsive" style="height:250px;">
						<?php } }?>

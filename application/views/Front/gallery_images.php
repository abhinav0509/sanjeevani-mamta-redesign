<script src="<?php echo base_url();?>front/js/lightbox-plus-jquery.min.js"></script>
<style>
.topsider_box h3 {
	color: #424040;
	font-size: 13px;
...
$(document).ready(function(){
	...
	<div class="container">
	 ...
	 <!-- LATEST NEWS START --> 
        <section class="latestNews section-padding myGalleryimgs">
            <div class="container">
                <div class="row all_news area_content">
				<?php foreach($album as $al){?>
				<h2 class="sec_Hd"><?php echo $al['title'];?> Album</h2>
				<?php }?>
				<?php foreach($result as $row){?>
                    <div class="col-sm-3 profileoptions">
                        <div class="single_news">
                            <figure>
                                <a class="example-image-link" href="<?php echo base_url()?>data/uploads/gallery/<?php echo $row['image'];?>" data-lightbox="example-1"><img class="example-image" src="<?php echo base_url()?>data/uploads/gallery/<?php echo $row['image'];?>" alt="image-1"  style="width:350px;height:180px;padding:0px;border:1px solid #f5f5f5;"/></a>
                            </figure>
                        </div>
                    </div>
				<?php }?>

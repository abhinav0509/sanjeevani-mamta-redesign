				 ...
				 <div class="sided" style="padding: 10px;margin-bottom:5px;">
					...
					<div class="categories area_content">
						...
						<?php foreach($facilities as $fac){?>
							<li><a href="<?php echo base_url();?>index.php/Welcome/medicalservices/<?php echo $fac['id'];?>"> <?php echo $fac['type'];?></a></li>
						<?php } ?>
						</ul>
					</div>
				 </div>		
			...
			<div class="col-md-9">
				...
				<?php if(!empty($result)){?>
					 ...
					 <?php foreach($result as $row){?>
						<h2 class="sec_Hd"> <?php echo $row['type'];?></h2>
						<?php if($row['image']!=""){
						$img = explode(",",$row['image']);
						if(count($img)>1){
						for($i=0; $i<count($img);$i++)	{	?>
						<div class="col-sm-6" style="padding:0px;">
						<img src="<?php echo base_url();?>data/uploads/medical/<?php echo $img[$i];?>" class="img-responsive" style="height:250px;">
						</div>
						<?php } } else {?>
						<img src="<?php echo base_url();?>data/uploads/medical/<?php echo $row['image'];?>" class="img-responsive" style="height:250px;">
						<?php } }?>

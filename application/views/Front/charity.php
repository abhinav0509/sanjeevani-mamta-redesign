			...
			<div class="col-md-9">
				...
				<?php if(!empty($result)){?>
					 <div class="about-countinner">
						...
						<h2 class="sec_Hd">CHARITY</h2>
						<?php foreach($result as $row){?>
						<h4>♦ <?php echo $row['title'];?></h4>
						<?php if($row['image']!=""){?>
						<img class="img-responsive singlebanner" src="<?php echo base_url();?>data/uploads/charity/<?php echo $row['image'];?>" style="width:100%;height:300px;">
						<?php } ?>

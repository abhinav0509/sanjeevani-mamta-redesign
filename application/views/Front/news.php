                        ...
                        <div class="about_cont">
							 <div class="about-countinner md-services">
								...
								<?php foreach($news as $row){?>
									...
									<img src="<?php echo base_url();?>data/uploads/news/<?php echo $img[$i];?>" class="img-responsive" style="height:250px;">
									</div>
									<?php } } } else {?>
									<img src="<?php echo base_url();?>data/uploads/news/<?php echo $row['image'];?>" class="img-responsive" style="height:250px;">
									<?php }?>
									
									<h4> <?php echo $row['title'];?> </h4>
									<h6><i class="fa fa-calendar"></i> <?php echo $row['insert_date'];?> </h6>
									<p> <?php echo strip_tags($row['pdesc']);?> </p>
								<?php }?>
							 </div>	
						</div>
                    </div>

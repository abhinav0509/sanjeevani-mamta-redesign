...
.page {
 ...
 <div class="breadcrumb-wrap" style="height:0px;">
	...
	<section class="mainContent full-width clearfix">
	  ...
	  <?php if(!empty($result)){?>
        <div class="sectionTitle text-center">
          <h2>
            <span class=""></span>
            <span class="color-4">Camp Data</span>
            <span class=""></span>
          </h2>
        </div>
          ...
          <div class="col-sm-4 col-xs-12">
            <div class="media servicesStyle">
              ...
              <div class="media-body">
                ...
                <p><?php echo substr(strip_tags($row['pdesc']),0,100);?></br><a href="<?php echo base_url();?>index.php/Singlecampdata/<?php echo $row['id'];?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> More...</a></p>
              </div>
            </div>
			<a href="javascript:;"></a>
		 </div>
	...
	<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/camp_data">

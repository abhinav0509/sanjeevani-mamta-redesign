...
.homeContactContent .form-group .form-control option{color:#333;}
            ...
            <div class="content-wrapper">
              ...
              <!-- Breadcrumb Start -->
                <div class="bg-f br-2" style="background-image: url();background-position: center center;background-size: cover;min-height: 400px !important;padding: 14% 0 !important;">
                    <div class="container">
                        <div class="breadcrumb-title">
                            <h2>Volunteer</h2>
                            <ul class="breadcrumb-menu list-style">
                                <li><a href="index.html">Home </a></li>
                                <li><a href="blog-no-sidebar.html">Volunteer</a></li>
                                <!--<li>Volunteer</li>-->
                            </ul>
                        </div>
                    </div>

<div class="content-wrapper">
                ...
                <section class="service-details-wrap ptb-100">
                    <div class="container">
					<span class="shape shape-left bg-color-4" style="background-color: #9fccdf!important; width: 20px; height: 21px; border-radius: 50%;display: inline-block;position: relative;top: 39px;left: 410px;"></span>
				             <span class="color-2" style="font-size:24px !important; text-align: center;"><h3><a style="    color: rgb(181,213,106);" >General Medicine</a></h3></span>
				              <span class="shape shape-right bg-color-4" style="background-color: #9fccdf!important; width: 20px; height: 21px; border-radius: 50%;display: inline-block;position: relative;top: -42px;left: 687px;"></span>
                        <div class="row gx-5">
						   	
			  
                             <div class="col-xl-8 pull-left myBorder" style="box-shadow: 6px 3px 10px rgb(0 0 0 / 10%); border: 1px solid rgba(0,0,0,.1); margin-top: 20px;">
                                <div class="service-desc">
                                    <!-- <h2>General Medicine </h2> -->
                                    <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing, elit. Quasi, porro expedita dolores quas nesciunt repellat sed. Nostrum sunt obcaecati totam distinctio libero ea aliquam hic a consectetur, et facere rem repudiandae maxime dolorem ad, saepe harum blanditiis laborum mollitia excepturi eaque corporis.</p> -->
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a class="single-service-img" data-fancybox="gallery" href="<?php echo base_url();?>assets/img/services/single-service-1.jpg">
                                                <img src="<?php echo base_url();?>assets/img/Dept/1.jpg" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-md-6">
                                            <a class="single-service-img" data-fancybox="gallery" href="<?php echo base_url();?>assets/img/services/single-service-2.jpg">
                                                <img src="<?php echo base_url();?>assets/img/Dept/2.jpg" alt="Image">
                                            </a>
                                        </div>
                                    </div>
                                    <h3>What We Offer Under This Service</h3>
                                    ...
                                    <!-- <a class="single-service-img" data-fancybox="gallery" href="assets/img/services/single-service-3.jpg">
                                        <img src="<?php echo base_url();?>assets/img/Dept/3.jpg" alt="Image">
                                    </a> -->
                            ...
                            <div class="col-xl-4">
                                <div class="sidebar">
                                    ...
                                    <div class="sidebar-widget" style="position: relative; top:20px;    box-shadow: 0px 7px 16px grey; ">
                                        <h4>Send Enquiry</h4>    
                                        <form action="#" class="contact-widget">
											...
											<div class="form-group">
                                                <input type="Mobile Number" placeholder="Number">
                                            </div>
                                            <div class="form-group">
                                                <textarea name="msg" id="msg" cols="30" rows="10" placeholder="Your Message"></textarea>
                                            </div>
                                            <button type="submit" class="btn style1 w-100 d-block">Send Now</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="service-slider-one owl-carousel">
                            <div class="service-card style1">
                                <div class="service-img">
                                    <img src="<?php echo base_url();?>assets/img/services/service-2.jpg" alt="Image">
                            ...
                            <div class="service-card style1">
                                <div class="service-img">
                                    <img src="<?php echo base_url();?>assets/img/services/service-6.jpg" alt="Image">
                                    <span class="service-icon"><i class="flaticon-nurse"></i></span>
                                </div>
                                <div class="service-info">
                                    <h3><a href="<?php echo base_url();?>service-details.html">Specialist Advise</a></h3>
                                    <p>It is a long established fact that reader will content of page when looks layout.</p>
                                    <a href="service-details.html" class="link style2">Explore More</a>
                                </div>
                            </div>
                            <div class="service-card style1">
                                <div class="service-img">
                                    <img src="<?php echo base_url();?>assets/img/services/service-3.jpg" alt="Image">
                            ...
                            <div class="service-card style1">
                                <div class="service-img">
                                    <img src="<?php echo base_url();?>assets/img/services/service-4.jpg" alt="Image">
                            ...
                            <div class="service-card style1">
                                <div class="service-img">
                                    <img src="<?php echo base_url();?>assets/img/services/service-5.jpg" alt="Image">
                            ...
                            <div class="service-card style1">
                                <div class="service-img">
                                    <img src="<?php echo base_url();?>assets/img/services/service-8.jpg" alt="Image">

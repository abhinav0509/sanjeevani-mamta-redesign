...
j(document).ready(function(){
		search();
		j(".Cashless").addClass("active");
	    j(".hospital").addClass("active");	
	...
	//     });
	  ...
	  j(".page").click(function () {
		...
		//    CKEDITOR.instances.pdisc.setData("");
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_cashlessfacility');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_cashlessfacility');
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/TPA/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_cashlessfacility",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/cashlessfacility_status",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
		   ...
		   source: function (request, response) {
			  j.ajax({
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getaboutus",
				    type: "POST",
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_data_cashlessfacility');
			j("#hfield").submit();
		}
		else if(t=="")
		{
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View TPA</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add TPA</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
								...
								<div class="table-responsive"> 
									...
									<table id="" class="table table-bordered" style="float:left;">
											<thead style="background: #f5f5f5; color: #FFF;">  
												  ...
												  <th width="08%" style="text-align:center;">Image</th>
												  <th width="08%" style="text-align:center;">Status</th>
											...
											<tbody id="tdata">
											  ...
											  <tr>
												  ...
												  <td style="text-align:center;  padding: 10px 30px;">
												   <?php if($row['image']!=""){?>
													   <img src="<?php echo base_url()?>data/uploads/TPA/<?php echo $row['image'];?>" style="width:100%;height:90px;border:0px solid #D7DADC;padding:3px">
												   <?php } else{?>
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/cashless_facility">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_cashlessfacility" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add TPA</h4>
										</div>

	...
	j(".td_text").slimscroll({
	  ...
	  j(".page").click(function () {
			  ...
			  if ((file = this.files[0])) {
				  ...
				  img.onload = function () {
					var ext = file.name.split('.').pop().toLowerCase();
					  ...
					  tp=file.type;                  
					  //alert("H="+h+"W="+w);
					  if(h < 400 && w >=1000 || h >=400 && h < 400 && w >=1000 || h < 400 && w < 1000){
						  alert("Please Upload Image In (400(Width) * 1000(Height)) Dimentions");
						  j("#upload").val("");
						  j("#img1").attr('src','');
						  j("#img1").html("");
					  }
					  else if (h == 400  && w == 1000) {
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_camp');
	   });
...
{
	j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_camp');
	...
	{
		var img_url = "<?php echo base_url();?>data/uploads/camp/"+l[k];
		if(l[k]=="No image"){  }
		else{
...
function Delete(id,obj){
	...
	j.ajax({
		url:"<?php echo base_url();?>index.php/Delete/delete_camp",
		type:"post",
		data:{'id':id},
...
function delete_one(id,img,all){
	...
	j.ajax({
		...
		success:function(data){
		   ...
		   j("#alert1").fadeIn('slow');
		   j("#alert1").delay(2000).fadeOut(300);
		   window.location="<?php echo base_url();?>index.php/Admin/camp";
		},
		error: function () {
...
function change_aboutus(id,str)
{
	if(confirm("Are you sure, you want to Change Status!.."))
		j.ajax({
			url:"<?php echo base_url();?>index.php/Status/camp",
			type:"post",
			data:{'id':id,'str':str},
			success:function(data){
...
function eachcheck(obj,Status){
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_camp');
			j("#hfield").submit();
		}
		else if(t==""){
				j('#alert1').show();
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Camp Details</a></li>
						...
						<div class="tab-content" style="margin:16px;">
								 ...
								 <div class="table-responsive"> 
									<table id="" class="table table-bordered" style="float:left;">
										<thead style="background: #f5f5f5; color: #FFF;"> 
											  ...
											  <th width="10%" style="text-align:center;">Total camp</th>
											  ...
											  <td style="text-align:center;"><?php echo $row['title'];?></td>
											   ...
											   <?php if($row['image']!=""){
												   ...
												   <div class="col-sm-6 imge" style="margin: 0px 3px; width: auto; padding: 5px;">
													   ...
													   <?php }else{?>
													   <img src="<?php echo base_url()?>data/uploads/camp/<?php echo $immg[$i];?>" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
													   <?php }?>
													   <div class="profile">
											   ...
											   <?php } } else {?>
														<img src="<?php echo base_url()?>data/uploads/camp/<?php echo $row['image'];?>" style="width:100%;height:90px;border:1px solid #D7DADC;padding:6px;">
												   <?php } } else{?>
													<img src="<?php echo base_url()?>data/images/noimg.png" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
											   <?php }?>
											   </td>
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/camp">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_camp" enctype="multipart/form-data">
									<div class="panel panel-default">
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<div class="form-group">
												<label class="col-sm-4 control-label" for="inputEmail3">Total Camp  <span class="asterisk">*</span></label>
												<div class="col-sm-8">
													<input type="text" placeholder="Total Camp" id="total" name="total" class="form-control" required>
												</div>
											</div>
											<div class="form-group">

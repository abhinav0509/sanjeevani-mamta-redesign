...
var j =jQuery.noConflict();
	j(document).ready(function(){
		search();
		j(".announcement").addClass("active");
	  ...
	  j(".page").click(function () {
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_announcement');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_announcement');
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/aboutus/"+l[k];
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_announcement",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/announcement_status",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
					...
					j("#alert1").fadeIn('slow');
					j("#alert1").delay(2000).fadeOut(300);
					window.location="<?php echo base_url();?>index.php/Admin/announcement";
				},
				error:function(){
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_data_announcement');
			j("#hfield").submit();
		}
		else if(t=="")
		{
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Announcement</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Announcement</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
										...
										<tbody id="tdata">
										  ...
										  <tr>
											   ...
											   <!-- <td style="text-align:center;  padding: 10px 0px;">
												   <?php if($row['image']!=""){?>
													   <img src="<?php echo base_url()?>assets/img/about/<?php echo $row['image'];?>" style="width:100%;height:90px;border:0px solid #D7DADC;padding:3px">
												   <?php } else{?>
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/announcement">
								...
								<input type="hidden" id="rcount" name="rcount" value="">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_announcement" enctype="multipart/form-data">

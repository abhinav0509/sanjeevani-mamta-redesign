...
var wordCountConf2 = {
  ...
  var j =jQuery.noConflict();
	j(document).ready(function(){
	  ...
	  j(".page").click(function () {
			  ...
			  if ((file = this.files[0])) {
				  ...
				  img.onload = function () {
					var ext = file.name.split('.').pop().toLowerCase();
					  ...
					  tp=file.type;                  
					  //alert("H="+h+"W="+w);
					  if(h < 90 && w >=90 || h >= 90 && w < 90 || h < 90 && w < 90){
						  alert("Please Upload Image In (90(Width) * 90(Height)) Diamensions");
						  j("#upload").val("");
						  j("#img1").attr('src','');
						  j("#img1").html("");
					  }
		...
		j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_testimonial');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_testimonial');
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/testimonial/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_testimonial",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/testimonial_status",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_data_testimonial');
			j("#hfield").submit();
		}
		else if(t=="")
		{
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							...
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Testimonial</a></li>
							<li class="pull-right">
						...
						<div id="tab1-1" class="tab-pane active">
										...
										<tbody id="tdata">
										  ...
										  <tr>
											   ...
											   <td style="text-align:center;  padding: 10px 0px;">
												   <?php if($row['image']!=""){?>
													   <img src="<?php echo base_url()?>data/uploads/testimonial/<?php echo $row['image'];?>" style="width:100%;height:90px;border:0px solid #D7DADC;padding:3px">
												   <?php } else{?>
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/testimonial">
						   ...
						   <div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_testimonial" enctype="multipart/form-data">
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<span class="asterisk">Upload Images in (90 * 90) Diamensions and allowed file Types are (jpg ,jpeg ,png)</span>
												</div>
											</div>
											<div class="col-sm-12">
											      <div class="form-group">
												     ...
												     <div class="col-sm-8">
												          <input type="text" placeholder="Job Designation,Location" id="designation" name="designation" class="form-control" required>
												     </div>
											       </div>
										      </div>
										</div>

...
j(document).ready(function(){
	search();
	search1();
	j(".camp").addClass("active");
	j(".camp").addClass("active open");
	...
	j(".td_text").slimscroll({
	  ...
	  j(".page").click(function () {
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_campdata');
	   });
...
function Edit(obj,id)
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_campdata');
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/campdata/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function delete_one(id,img,all){
		...
		j.ajax({
			...
			success:function(data){
               ...
               j("#alert1").fadeIn('slow');
               j("#alert1").delay(2000).fadeOut(300);
			   window.location="<?php echo base_url();?>index.php/Admin/camp_data";
            },
            error: function () {
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Camp</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Camp</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
										  ...
										  <tr>
											   ...
											   <td style="text-align:center;  padding: 10px 0px;">
												   ...
												   <div class="col-sm-6 imge" style="margin: 0px 3px; width: auto; padding: 5px;">
													   ...
													   <?php }else{?>
													   <img src="<?php echo base_url()?>data/uploads/campdata/<?php echo $immg[$i];?>" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
													   <?php }?>
													   <div class="profile">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_campdata" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Camp</h4>
										</div>
...
<form id="formh" name="formh" method="post" action="<?php echo base_url();?>index.php/Update/singleimage_campdata" enctype="multipart/form-data">

...
j(document).ready(function(){
	...
	j(".td_text").slimscroll({
	   ...
	   j("#sub_mnu2").val(j("#page").val());
	   j("#sub_mnu1").val(j("#type1").val());
	  ...
	  j(".page").click(function () {
		  ...
		  j("#page").val(j("#sub_mnu2").val());
		  j("#type1").val(j("#sub_mnu1").val());
		  j('#hfield').submit();
	   });
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_vission');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_vission');
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_vission",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/vission",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
		   ...
		   source: function (request, response) {
			  j.ajax({
				 ...
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getvission",
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_vission');
			j("#hfield").submit();
		}
		else if(t==""){
				j('#alert1').show();
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Mission_Vision</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Mission_Vision</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
								 ...
								 <div class="row">
										<div class="col-sm-12" style="padding-bottom: 10px;">
										  <div class="form-group">                                            
												...
												<div class="col-sm-3">
													<input type="text" id="sub_mnu1" name="sub_mnu1" class="form-control" placeholder="Search By Title Name" />
												</div>
												<div class="col-sm-3">
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/mission_vission">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_vission" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Mission & Vision</h4>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<select id="type" name="type" class="form-control" onchange="view(this.value)">
														<option value="">Select Type</option>
														<option value="Mission">Mission</option>
														<option value="Vision">Vision</option>
													</select>

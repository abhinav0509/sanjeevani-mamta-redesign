...
var j =jQuery.noConflict();
	j(document).ready(function(){
		search();
		j(".patienteducation").addClass("active");
	  ...
	  j(".page").click(function () {
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_patienteducation');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_patienteducation');
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_patienteducation",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/patienteducation_status",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
					...
					j("#alert1").fadeIn('slow');
					j("#alert1").delay(2000).fadeOut(300);
					window.location="<?php echo base_url();?>index.php/Admin/patienteducation";
				},
				error:function(){
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_data_patienteducation');
			j("#hfield").submit();
		}
		else if(t=="")
		{
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Patienteducation Details</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Patienteducation</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
									...
									<table id="" class="table table-bordered" style="float:left;">
										<thead style="background: #f5f5f5; color: #FFF;">  
											  <th width="2%" style="text-align:center;">
											      ...
											      <th width="9%" style="text-align:center;">Title</th>
												  <th width="9%" style="text-align:center;">Image</th>
												  <th width="15%" style="text-align:center;">Description</th>
												  <th width="09%" style="text-align:center;">Status</th>
												  <th width="09%" style="text-align:center;">Action</th>                                                            
										</thead>
										<script>							
										  var jArray=[];
										...
										<tbody id="tdata">
										  ...
										  <tr>
											   ...
											   <td style="text-align:center;  padding: 10px 0px;">
												   <?php if($row['image']!=""){?>
													   <img src="<?php echo base_url()?>data/uploads/patient/<?php echo $row['image'];?>" style="width:100%;height:90px;border:0px solid #D7DADC;padding:3px">
												   <?php } else{?>
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/patienteducation">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_patienteducation" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Patienteducation</h4>
										</div>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="col-sm-8">
												    <input type="text" placeholder="Title" id="name" name="name" class="form-control" required>
												</div>
											</div>
											<div class="form-group">

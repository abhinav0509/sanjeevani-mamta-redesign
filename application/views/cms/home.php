...
/*	    j('#upload').change(function(e){
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_about');
	    });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_aboutus');
		...
		{
			var img_url = "<?php echo base_url();?>assets/img/about/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_aboutus",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/aboutus",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/about');
			j("#hfield").submit();
		}
		else if(t=="")
		{
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							...
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add About Us</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
											    ...
											    <td style="text-align:center;  padding: 10px 0px;">
												   ...
												   for($i=0;$i<count($immg);$i++){?>
												    <div class="col-sm-6 imge" style="margin: 0px 9px; width: auto; padding: 5px;">
													   ...
													   <?php }else{?>
													   <img src="<?php echo base_url()?>data/uploads/about/<?php echo $immg[$i];?>" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
													   <?php }?>
													    <div class="profile">
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/index">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_about" enctype="multipart/form-data">

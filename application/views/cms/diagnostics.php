	...
	j(".td_text").slimscroll({
	  ...
	  j(".page").click(function () {
			  ...
			  if ((file = this.files[0])) {
				  ...
				  img.onload = function () {
					var ext = file.name.split('.').pop().toLowerCase();
					  ...
					  tp=file.type;                  
					  //alert("H="+h+"W="+w);
					  if(h < 250 && w >=500 || h >= 250 && w < 500 || h > 250 && w > 500 || h < 250 && w < 500){
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_diagnostics');
	   });
...
function Edit(obj,id)
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_diagnostics');
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/diagnostics/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_diagnostics",
			type:"post",
			data:{'id':id},
	...
	function delete_one(id,img,all){
		if(confirm("Are you sure! you want to delete It.."))
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/singleimage_diagnostics",
			type:"post",
			...
			success:function(data){
               ...
               j("#alert1").fadeIn('slow');
               j("#alert1").delay(2000).fadeOut(300);
			   window.location="<?php echo base_url();?>index.php/Admin/diagnostics";
            },
            error: function () {
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/diagnostics",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
		   ...
		   source: function (request, response) {
			  j.ajax({
				 ...
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getdiagnostic",
	...
	j("#sub_mnu2").autocomplete({
		   source: function (request, response) {
			  j.ajax({
				  type: "POST",
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getdiatitlte",
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_diagnostics');
			j("#hfield").submit();
		}
		else if(t==""){
				j('#alert1').show();
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Diagnostics</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Diagnostics</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
										  ...
										  <tr>
											   ...
											   <td style="text-align:center;  padding: 10px 0px;">
												   ...
												   <div class="col-sm-6 imge" style="margin: 0px 3px; width: auto; padding: 5px;">
													   ...
													   <?php }else{?>
													   <img src="<?php echo base_url()?>data/uploads/diagnostics/<?php echo $immg[$i];?>" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
													   <?php }?>
													   <div class="profile">
											   ...
											   <td>
												   <select name="status" id = "status" class="form-control" onchange="change_aboutus('<?php echo $row['d_id'];?>',this.value)">
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/diagnostics">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_diagnostics" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Diagnostics Description</h4>
										</div>
										...
										<div class="col-sm-6">
											...
											<div class="form-group" style="display:none;" id="add1">
												<label class="col-sm-4 control-label" for="inputEmail3">Type <span class="asterisk">*</span></label>
												<div class="col-sm-8">
													<input type="text" placeholder="Add New Diagnostics" id="type" name="type" class="form-control">
												</div>
											</div>
											<div class="form-group">
...
<form id="formh" name="formh" method="post" action="<?php echo base_url();?>index.php/Update/singleimage_diagnostics" enctype="multipart/form-data">

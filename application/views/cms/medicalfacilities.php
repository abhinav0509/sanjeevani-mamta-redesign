...
<!--<link rel="stylesheet" href="<?php echo base_url();?>data/dist/css/plugins/jquery-icheck.min.css">
<link rel="stylesheet" href="<?php echo base_url();?>data/dist/assets/plugins/jquery-icheck/skins/all.css">
<script src="<?php echo base_url();?>data/dist/assets/plugins/jquery-icheck/icheck.min.js"></script>
<script src="<?php echo base_url();?>data/dist/js/icheck.js"></script>-->
...
j(document).ready(function(){
	search();
	search1();
	j(".medical").addClass("active");
	j(".hospital").addClass("active open");
	...
	j(".td_text").slimscroll({
	  ...
	  j(".page").click(function () {
			  ...
			  if ((file = this.files[0])) {
				  ...
				  img.onload = function () {
					var ext = file.name.split('.').pop().toLowerCase();
					  ...
					  tp=file.type;                  
					  //alert("H="+h+"W="+w);
					  if(h < 320 && w >=1000 || h >= 320 && w < 1000 || h > 320 && w > 1000 || h < 320 && w < 1000){
						  alert("Please Upload Image In (1000(Width) * 320(Height)) Dimentions");
						  j("#upload").val("");
						  j("#img1").attr('src','');
						  j("#img1").html("");
					  }
					  else if (h == 320  && w == 1000) {
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_medicalfacility');
	   });
...
function Edit(obj,id)
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_medicalfacility');
		...
		j("#med_type").val(obj[0][r].type_id);
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/medical/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_medicalfacility",
			type:"post",
			data:{'id':id},
	...
	function delete_one(id,img,all){
		if(confirm("Are you sure! you want to delete It.."))
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/singleimage_medicalfacility",
			type:"post",
			...
			success:function(data){
               ...
               j("#alert1").fadeIn('slow');
               j("#alert1").delay(2000).fadeOut(300);
			   window.location="<?php echo base_url();?>index.php/Admin/medicalfacilities";
            },
            error: function () {
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/medicalfacility",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
		   ...
		   source: function (request, response) {
			  j.ajax({
				 ...
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getfacility",
					data: { term: j("#type").val()},
					dataType: "json",
					  success: function (data) {
						   response(j.map(data, function (item) {
							  return {
								  label: item.type,// Name must be column name in table which you want to show Ex:- Username
								  json: item
							  }
						  }))
					  },
	...
	j("#sub_mnu2").autocomplete({
		   source: function (request, response) {
			  j.ajax({
				  type: "POST",
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getmedtitle",
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_facilities');
			j("#hfield").submit();
		}
		else if(t==""){
				j('#alert1').show();
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Facility</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Facility</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
										  ...
										  <div class="form-group">
												<div class="col-sm-3">
													...
													<?php foreach($facility as $fac){?>
														<option value="<?php echo $fac['id'];?>"><?php echo $fac['type'];?></option>
													<?php }?>
													</select>
												</div>
												<div class="col-sm-3">
									...
									<table id="" class="table table-bordered" style="float:left;">
										<thead style="background: #f5f5f5; color: #FFF;">   
											 <th width="3%">
											  ...
											  <th width="23%" style="text-align:center;">Image</th>
										  ...
										  <tr>
											   ...
											   <td style="text-align:center;  padding: 10px 0px;">
												   ...
												   <div class="col-sm-6 imge" style="margin: 0px 5px; width: auto; padding: 4px;">
													   ...
													   <?php }else{?>
													   <img src="<?php echo base_url()?>data/uploads/medical/<?php echo $immg[$i];?>" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
													   <?php }?>
													   <div class="profile">
												   ...
												   <?php } } else {?>
														<img src="<?php echo base_url()?>data/uploads/medical/<?php echo $row['image'];?>" style="width:100%;height:90px;border:1px solid #D7DADC;padding:6px;">
												   <?php } }else{?>
														<img src="<?php echo base_url()?>data/images/noimg.png" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
												   <?php }?>
											   </td>
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/medicalfacilities">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_medicalfacility" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Facility Description</h4>
										</div>
										...
										<div class="col-sm-6">
											...
											<div class="form-group" style="display:none;" id="add1">
												<label class="col-sm-4 control-label" for="inputEmail3">Type <span class="asterisk">*</span></label>
												<div class="col-sm-8">
													<input type="text" placeholder="Add New Facility" id="type" name="type" class="form-control">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-4 control-label" for="inputEmail3">Titile</label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<span class="asterisk">Upload Image in (1000 X 320) Dimention and allowed file Types are (jpg ,jpeg ,png)</span>
												</div>
											</div>
										</div>
										<div class="col-sm-6">
...
<form id="formh" name="formh" method="post" action="<?php echo base_url();?>index.php/Update/singleimage_medicalfacility" enctype="multipart/form-data">

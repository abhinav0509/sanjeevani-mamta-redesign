...
var Frarr =[];
	j(document).ready(function(){
	  ...
	  j(".page").click(function () {
			  ...
			  if ((file = this.files[0])) {
				  ...
				  img.onload = function () {
					var ext = file.name.split('.').pop().toLowerCase();
					  ...
					  tp=file.type;                  
					  //alert("H="+h+"W="+w);
					  if(h < 250 && w >=470 || h >= 250 && w < 470 || h < 250 && w < 470){
						  alert("Please Upload Image In (470(Width) * 250(Height)) Dimentions");
						  j("#upload").val("");
						  j("#img1").attr('src','');
						  j("#img1").html("");
					  }
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_mission');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_mission');
		...
		{
			var img_url = "<?php echo base_url();?>data/uploads/mission/"+l[k];
				if(l[k]=="No image"){  }
				else{
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_mission",
			type:"post",
			data:{'id':id},
	...
	function delete_one(id,img,all){
		if(confirm("Are you sure! you want to delete It.."))
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/singleimage_mission",
			type:"post",
			...
			success:function(data){
               ...
               j("#alert1").fadeIn('slow');
               j("#alert1").delay(2000).fadeOut(300);
			   window.location="<?php echo base_url();?>index.php/Admin/smssh";
            },
            error: function () {
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/mission",
				type:"post",
				data:{'id':id,'str':str},    
				success:function(data){
		   ...
		   source: function (request, response) {
			  j.ajax({
				 ...
				 // contentType: "application/json; charset=utf-8",
					url: "<?php echo base_url();?>index.php/Search_Data/Getmission",
	...
	function clickAction()
	{
		...
		{
			if(confirm("Are you sure, you want to delete It.."))
			j("#hfield").attr('action','<?php echo base_url();?>index.php/Delete_Data/delete_mission');
			j("#hfield").submit();
		}
		else if(t=="")
		{
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						<ul class="nav nav-tabs" style="margin:16px;margin-top:0px;">
							<li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Hospital Details</a></li>
							<li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Add Hospital Details</a></li>
							<li class="pull-right">
						...
						<div class="tab-content" style="margin:16px;">
										...
										<tbody id="tdata">
										  ...
										  <tr>
											   ...
											   <td style="text-align:center;  padding: 10px 0px;">
												   ...
												   <div class="col-sm-6 imge" style="margin: 0px 9px; width: auto; padding: 5px;">
													   ...
													   <?php }else{?>
													   <img src="<?php echo base_url()?>data/uploads/hospital/<?php echo $immg[$i];?>" style="width:90px;height:90px;border:1px solid #D7DADC;margin:0px">
													   <?php }?>
													   <div class="profile">
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/smssh">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" action="<?php echo base_url();?>index.php/Insert/insert_mission" method="post" enctype="multipart/form-data">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h4 class="panel-title">Add Mission's</h4>
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													...
													<span class="asterisk">Upload Images in (470 * 250) Dimention and allowed file Types are (jpg ,jpeg ,png)</span>
												</div>
											</div>
										</div>
										<div class="col-sm-6">
...
<form id="formh" name="formh" method="post" action="<?php echo base_url();?>index.php/Update/singleimage_mission" enctype="multipart/form-data">

...
var j =jQuery.noConflict();
	j(document).ready(function(){
	  ...
	  j(".page").click(function () {
	   ...
	   j("#Cancelbtn").click(function(){
		   ...
		   j("#formdetail").attr('action','<?php echo base_url();?>index.php/Insert/insert_about1');
	   });
	...
	{
		j("#formdetail").attr('action','<?php echo base_url();?>index.php/Update/update_about1');
	...
	function Delete(id,obj){
		...
		j.ajax({
			url:"<?php echo base_url();?>index.php/Delete/delete_about1",
			type:"post",
			data:{'id':id},
	...
	function change_aboutus(id,str)
	{
		if(confirm("Are you sure, you want to Change Status!.."))
			j.ajax({
				url:"<?php echo base_url();?>index.php/Status/about1",
				type:"post",
				data:{'id':id,'str':str},
				success:function(data){
					...
					j("#alert1").fadeIn('slow');
					j("#alert1").delay(2000).fadeOut(300);
					window.location="<?php echo base_url();?>index.php/Admin/aboutus";
				},
				error:function(){
				...
				<div style="height: 925px;margin: 0px;" class="tab-content">	
					<div class="row">
						...
						<div class="tab-content" style="margin:16px;">
							...
							<form id="hfield" name="hfield" method="post" action="<?php echo base_url();?>index.php/Admin/aboutus">
							...
							<div id="tab1-2" class="tab-pane">
								<form id="formdetail" name="formdetail" class="form-horizontal" method="post" action="<?php echo base_url();?>index.php/Insert/insert_about1" enctype="multipart/form-data">
